...
class Widgets:
    def __init__(self,screen): #Define the surface screen
        self.screen = screen
        ...
        self.textSurf, textRect = self.text_objects("Initialize with Random data", self.smallText,BLACK)
    ...
    def button(self,msg,x,y,w,h,ic,ac,action=None): # Create Buttons
        ...
        if x+w > mouse[0] > x and y+h > mouse[1] > y:
            ...
            self.smallText = pygame.font.SysFont(None,20)
            self.textSurf, self.textRect = self.text_objects(msg, self.smallText,BLACK)
